...
export default function PrivacyPolicy() {
  return (
    <div className="mx-5 my-5">
      <h2>Privacy Policy for Devsnest Pvt. Ltd.</h2>
      <p>
        At Devsnest, accessible from devsnest.in, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document contains types
        of information that is collected and recorded by Devsnest and how we use
        it.
      </p>
      <p>
      ...
      <p>
        ...
        Furthermore, these files also help in logging in faster and act as a
      ...
      <p>
        ...
        advertising partners of Devsnest. Our Privacy Policy was created with
      ...
      <p>
        Devsnest does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in Devsnest. This policy is not applicable to any
        information collected offline or via channels other than this website.
        Consent By submitting data to us or our agent or using the Site, you
        consent to our use of your data in the manner set out in this Privacy
        Policy.
      </p>
    </div>
  );
